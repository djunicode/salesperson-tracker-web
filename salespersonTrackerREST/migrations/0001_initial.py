# Generated by Django 2.2.10 on 2020-02-27 18:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Managed_By', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='salespersonTrackerRest.Manager')),
                ('User_ref', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
